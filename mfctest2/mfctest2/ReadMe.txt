================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: mfctest2 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した mfctest2 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには mfctest2 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
mfctest2.h
   ...
   Cmfctest2App アプリケーション クラスを宣言します。

mfctest2.cpp
   これは、アプリケーション クラス Cmfctest2App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\mfctest2.ico
   ...
   アイコンはメイン リソース ファイル mfctest2.rc に含まれていま
   す。
...
mfctest2Doc.h, mfctest2Doc.cpp - ドキュメント
   これらのファイルは Cmfctest2Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via Cmfctest2Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

mfctest2View.h, mfctest2View.cpp - ドキュメントのビュー
   これらのファイルは Cmfctest2View クラスを含みます。
   Cmfctest2View オブジェクトは Cmfctest2Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   mfctest2.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
