================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: mfctest1 プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した mfctest1 には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには mfctest1 アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
mfctest1.h
   ...
   Cmfctest1App アプリケーション クラスを宣言します。

mfctest1.cpp
   これは、アプリケーション クラス Cmfctest1App を含むメイン アプリケー
   ション ソース ファイルです。
...
res\mfctest1.ico
   ...
   アイコンはメイン リソース ファイル mfctest1.rc に含まれていま
   す。
...
mfctest1Doc.h, mfctest1Doc.cpp - ドキュメント
   これらのファイルは Cmfctest1Doc クラスを含みます。特別なドキュメント 
   データを追加したり、ファイルを保存したり、
   (via Cmfctest1Doc::Serialize) を読み込んだりするには、これらのファイ
   ルを編集してください。

mfctest1View.h, mfctest1View.cpp - ドキュメントのビュー
   これらのファイルは Cmfctest1View クラスを含みます。
   Cmfctest1View オブジェクトは Cmfctest1Doc オブジェクトを表示す
   るのに使用されます。
...
StdAfx.h, StdAfx.cpp
   ...
   mfctest1.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
